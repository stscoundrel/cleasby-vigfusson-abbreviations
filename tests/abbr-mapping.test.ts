...
describe('Abbreviation mapping tests', () => {
  ...
  test('Abbreviations in map expected content', () => {
    ...
    expect(resultMap.get('f. or fem.')).toBe('feminine.');
    ...
    expect(resultMap.get('gl. or gloss.')).toBe('glossary.');
    ...
    expect(resultMap.get('m. or masc.')).toBe('masculine.');
    ...
    expect(resultMap.get('n. or neut.')).toBe('neuter.');
    ...
    expect(resultMap.get('Ormul. or Orm.')).toBe('Ormulum.');
